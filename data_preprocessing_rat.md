Data Preprocessing for Rat Inspection Dataset
================
Jia Ji, Yijia Jiang, Gonghao Liu, Yifei Xu, Ziyan Xu
2022-11-21
...
Then we clean the date and keep the records between 2013 and 2021. All
...
Since the raw dataset is too large, we will export the tidied dataset
which is merged with weather info and covid info for further use.
